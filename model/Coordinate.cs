...
namespace XYZ.model
{
    class Coordinate
    {
        ...
        {
            Submesh.ColorToRgba32(System.Drawing.Color.Silver), //y axis
            Submesh.ColorToRgba32(System.Drawing.Color.Orange) //z axis                                       
        };
        readonly GLNKG.Graphics.Color4[] label_colors = 
        {
            GLNKG.Graphics.Color4.Green, // x axis
            GLNKG.Graphics.Color4.Orange //y axis                                                        
        };
        readonly string[] names = {"data/bed.stl", "data/cube_with_round.stl" };
        #endregion
        ...
        internal Coordinate()
        {
            submesh = new Submesh[2];
            model = new TopoModel[2];
        ...
        internal void Draw(int viewport_x, int viewport_y, double rotX, double rotZ)
        {
            ...
            GL.Viewport(viewport_x - 140, 0, area_size, area_size); // change viewport
